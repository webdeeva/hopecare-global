    ...
    <section className="relative isolate overflow-hidden bg-cream pt-20 md:pt-24 pb-16 md:pb-20">
      ...
      <div className="container-wide">
        ...
        >
          ...
          <span className="hidden sm:inline">Replies Within Two Business Days</span>
          <div className="hidden md:block flex-1 h-px bg-navy/12" />
          <span className="hidden md:inline">support@hopecareglobal.org</span>
        </motion.div>
        ...
        <div className="mt-10 md:mt-14 max-w-3xl">
          ...
          >
            Let&apos;s{" "}
            <span className="text-gradient-brand">talk</span>.
          </motion.h1>
          ...
          >
            ...
            <strong className="text-navy font-semibold">volunteer</strong>,
            propose a <strong className="text-navy font-semibold">partnership</strong>,
            give in tribute, or share your story — this is the front door.
            We read every note.
          </motion.p>
        </div>
      </div>
