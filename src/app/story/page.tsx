    ...
    <main className="min-h-screen bg-[#0a2540] py-24 px-6 md:px-12 text-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg text-white/90">
          ...
          <p>At 38 years old, with no children, my health reached a turning point. After looking closely at my medical history, my surgeon strongly recommended I have a hysterectomy and have my fallopian tubes removed to lower my risk of ovarian cancer.</p>
          <p>That recommendation led me to have a hysterectomy along with removal of my fallopian tubes, done at the same time as a procedure I already needed. I didn't fully grasp how important that decision was back then. Research now shows that many aggressive ovarian cancers actually start in the fallopian tubes. Removing them doesn't erase the risk of ovarian cancer completely, but it can meaningfully lower it.</p>
          <p>Understanding my own risk, and learning that there's still no reliable routine test to screen for ovarian cancer, gave my pain a new purpose. I focused my doctoral research on how technology can help doctors and nurses catch subtle symptoms and warning signs earlier and more accurately.</p>
