  ...
  return (
    <main className="py-24 px-6 md:px-12 max-w-4xl mx-auto">
      ...
      <div className="prose prose-lg text-ink-soft">
        ...
        <p>At age 38, my health journey reached a critical juncture. My gynecological surgeon, evaluating my complex clinical history, underscored the urgency: <em>&ldquo;Remove this—you are at very high risk for ovarian cancer.&rdquo;</em> This imperative led to a hysterectomy with opportunistic salpingectomy—the surgical removal of my fallopian tubes during an already necessary pelvic procedure. At the time, I could not have fully grasped the significance of that decision. Emerging research now identifies the fallopian tubes as a primary site of origin for many ovarian malignancies; while salpingectomy does not eliminate risk entirely, it provides a crucial risk-reduction strategy.</p>
